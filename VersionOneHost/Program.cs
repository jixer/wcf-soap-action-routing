    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            using (var host = new ServiceHost(typeof(VersionServiceV1), new Uri("http://localhost:9091/routing/")))
            {
                ...
                // expose the version 1 service.  It will be hosted on port 9091 with the same relative path as our version 1
                // service
                ...
                // the base address + "?wsdl"   http://localhost:9091/routing/?wsdl
